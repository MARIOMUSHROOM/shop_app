...
import 'package:shop_app/feature/recommendation/controller/recommendation_controller.dart';
...
class _RecommendationPageState extends State<RecommendationPage> {
  ...
  @override
  void initState() {
    controller = RecommendationController(context);
    controller!.init();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      value: controller,
      child: Consumer<RecommendationController>(builder: (context, con, _) {
        return SafeArea(
          child: Scaffold(
            appBar: AppBar(
